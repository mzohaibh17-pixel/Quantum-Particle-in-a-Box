...
- Plots of energy levels as a function of quantum number.  
- Wavefunctions ψ_n(x) for different `n`.  
- Probability density plots |ψ_n(x)|².  
- Visual comparison of energy dependence on box length and particle mass.
